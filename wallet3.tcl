...
array set opts $argv
msgcat::mcload [format $opts(--language-dir) $mepath]
...
proc writeam {} {
	...
	set ::tram "Subject: $::subj\n[.msg.body get 1.0 end]"
	if {$::exitmsg == 1} {
		bind .msg <Destroy> {}
		destroy .msg
	}
}
button .trans.am -text "Write Message (instead of sending coins)" -command writeam
...
button .trans.send -text "Send Coins or Message" -command {apply {{} {
	if [wallet::issyncing] {
